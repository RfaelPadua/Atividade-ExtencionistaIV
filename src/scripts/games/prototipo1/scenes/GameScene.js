...
export default class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Criar texto de vida
        this.lifeText = this.add.text(300, 650, 'Life: 3', { fontSize: '32px', fill: '#ffffff', fontFamily: 'Exo_Space' });
        this.lifeText.x = this.screenWidth - (this.lifeText.width + 16);

        // Criar texto de pontuação
        this.scoreText = this.add.text(16, 650, 'Score: 0', { fontSize: '32px', fill: '#ffffff', fontFamily: 'Exo_Space' });

        // Campo de entrada de texto
        this.inputField = this.add.text(225, 625 - this.scoreText.height, '', { fontSize: '32px', fill: '#FFF', fontFamily: 'Exo_Space' });
